...
A form collects the information needed to do something: create a project,
update settings, or save a configuration. Validation checks that information
and helps the user correct it before continuing. If a save fails, the form
should explain what happened and keep their work ready to try again.
