...
browser** ([`fleury serve`](/fleury/architecture/serving-and-embedding/)). There is no
...
app already produces. [Built for agents](/fleury/architecture/agents-and-semantics/)
