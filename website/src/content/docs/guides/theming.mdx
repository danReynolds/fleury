...
Before building one from scratch: `fleury_themes` ships the palettes you
already know, each a plain `const ThemeData`.
...
for how to write your own — the rest of this guide covers the pieces it uses.
