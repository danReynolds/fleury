...
/// 8 that depend on `dart:io` — directly (file I/O, log capture, process
...
///
/// Excluded: file_browser, file_picker, form, image, log_region, process_panel, terminal_output_region, workflow_snapshot.
library;
