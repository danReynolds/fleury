...
/// Solarized Light — Precision colours for machines and people, light background.
///
/// <https://ethanschoonover.com/solarized>
///
/// Sets an explicit opaque background/surface/foreground: the point of
/// picking Solarized Light is to get *Solarized Light's* look, not to blend with the
...
const ThemeData solarizedLight = ThemeData(
