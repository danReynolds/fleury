...
// element for that build, the way `context.listen` does. AnimationBuilder
// (animation_builder.dart) owns this lifecycle for declarative
// target-following; manually owned animations must be disposed.
...
class Animation<T> extends Notifier {
  ...
  /// `TickerMode.of` establishes a scope dependency on the
