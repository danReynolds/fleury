...
void main() {
  testWidgets('an unmounted cached boundary does not leave ghost cells', (
    ...
    // Assert the damage contract on every frame below, not just the one the
    // expectations inspect: a real widget tree exercises paths (cache hits,
    // unmounts, sibling repaints) that hand-built buffer fixtures do not.
    ...
    expect(
      flipped.damage.requiresFullDiff,
      isFalse,
