...
// outside dirtyBounds/dirtyRows. The DOM surface regenerates only
...
// curve advanced.
//
// TuiFrameLoop closes this from buffer coverage. This asserts the completion
// survives all the way through the planner into the dirtyRowModels a surface
// actually applies.
//
// FramePresentationPlanner is core (fleury_web only re-exports it), so this
// lives here rather than in the browser package.
