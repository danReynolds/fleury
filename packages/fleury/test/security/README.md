...
| External processes and editors | File paths or command metadata cross into shell execution unintentionally. | `effects_security_boundary_test.dart`, `../effects/external_editor_test.dart` | Covered |
