...
void main() {
  ...
  test(
    'Logs search opens via the real TextInputEvent path',
    () async {
      ...
      driver.enqueue(const KeyEvent(keyCode: KeyCode.f12));
      await _settle();
      ...
      driver.enqueue(const KeyEvent(keyCode: KeyCode.tab)); // → Errors
      await _settle();
      driver.clearOutput();
      driver.enqueue(
        const KeyEvent(keyCode: KeyCode.tab, modifiers: {KeyModifier.shift}),
