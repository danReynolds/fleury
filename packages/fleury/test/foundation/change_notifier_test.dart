...
void main() {
  group('ChangeNotifier', () {
    ...
    test(
      'a listener removed during notification is not subsequently called',
      () {
        final c = _Counter();
        var first = 0;
        var second = 0;
        ...
        expect(
          ...
          0,
          reason:
              'a listener removed during notification must not be called '
    ...
    test(
      'disposing the notifier mid-notification halts the remaining listeners',
      () {
        final c = _Counter();
        var later = 0;
    ...
    test(
      'compaction keeps surviving listeners live across later notifications',
      () {
        final c = _Counter();
        var first = 0;
        var third = 0;
