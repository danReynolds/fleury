...
- Fleury can offer stronger semantic testing and structured automation than
  ...
  core semantic nodes, tester queries, debug inspector summaries, proof-app
...
- Fleury can offer a stronger Dart-native retained-reactive app model than
  ...
  scenario benchmarks, terminal capability contracts, and example proof-app
...
| SB.10 Proof-App Journey | All peers where an equivalent app exists | End-to-end app pressure: navigation, composer, data table, logs, commands, diagnostics, semantic assertions. |
...
- Raw render throughput may favor Bubble Tea v2, Ratatui, or OpenTUI. Fleury
  ...
  capability diagnostics, terminal safety, and stability under proof-app
  workflows.
