...
typedef Scenario = ({
  ...
  int cols,
  int rows,
  List<void Function(CellBuffer)> frames
});
        ...
        for (var i = 0; i < 60; i++)
          (b) {
            ...
            for (var r = 0; r < 60; r++) {
              ...
              for (var c = 0; c < 200; c++) {
                sb.writeCharCode(glyphs
                    .codeUnitAt((i * 7 + r * 13 + c * 3) % glyphs.length));
              }
